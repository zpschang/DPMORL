...
class BaseRunner:
    ...
    def create_env(
        ...
        if is_safety_gym_env(agent_cfg['env_name']):
            ...
            if 'Sauted' in agent_cfg['env_name'] or "MORL" in agent_cfg['env_name']:
                from envs.safety_gym.augmented_sg_envs import AugmentedSafeEngine, saute_env_cfg
                env_cfg = saute_env_cfg
                # print("***************************")
                # print(env_cfg)
        ...
        elif agent_cfg['env_name'] == 'MORLMountainCar':
            env_cfg = set_overrides(mcar_cfg, env_cfg_override)
            agent_cfg['max_ep_len'] =  env_cfg['max_ep_len']
            train_env_fn = lambda : gym.make("MORLMountainCar-v0",
                             safety_budget=agent_cfg['safety_budget'],
                             saute_discount_factor=env_cfg['saute_discount_factor'],
                             max_ep_len=agent_cfg['max_ep_len'],
                             mode="train",
            ...
            test_env_fn = lambda : gym.make("MORLMountainCar-v0",
                             safety_budget=agent_cfg['safety_budget'],
                             saute_discount_factor=env_cfg['saute_discount_factor'],
                             max_ep_len=agent_cfg['max_ep_len'],
                             mode="test",
        ...
        elif agent_cfg['env_name'] == 'MORLPendulum':
            env_cfg = set_overrides(pendulum_cfg, env_cfg_override)
            agent_cfg['max_ep_len'] = env_cfg['max_ep_len']
            train_env_fn = lambda : gym.make("MORLPendulum-v0",
                             safety_budget=agent_cfg['safety_budget'],
                             saute_discount_factor=env_cfg['saute_discount_factor'],
                             max_ep_len=agent_cfg['max_ep_len'],
                             mode="train",
            ...
            test_env_fn = lambda : gym.make("MORLPendulum-v0",
                             safety_budget=agent_cfg['safety_budget'],
                             saute_discount_factor=env_cfg['saute_discount_factor'],
                             max_ep_len=agent_cfg['max_ep_len'],
                             mode="test",
